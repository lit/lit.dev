...
export const pageRedirects = new Map(
  [
    ...
    [
      '/msg/dev-mode',
      '/docs/tools/development/#development-and-production-builds',
    ],
    ...
    [
      '/msg/change-in-update',
      '/docs/components/properties/#when-properties-change',
    ],
    [
      '/msg/deprecated-import-path',
      '/docs/releases/upgrade/#update-packages-and-import-paths',
    ],
    ...
    [
      '/msg/expression-in-template',
      '/docs/templates/expressions/#invalid-locations',
    ],
    [
      '/msg/expression-in-textarea',
      '/docs/templates/expressions/#invalid-locations',
    ],
  ].map(([path, redir]) => [

...
You're using the `@query` decorator or `querySelector` to access the `slot`
elements. This will be used to to see their currently `assignedElements`.
...
The `updateSlots` method removes any currently

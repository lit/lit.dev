...
This tutorial doesn't cover light DOM projection, but you can learn more about it in [this article](https://web.dev/shadowdom-v1/#composition-and-slots) or the [Lit documentation](/docs/components/shadow-dom/#slots).

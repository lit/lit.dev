...
This tutorial uses only a few of the features supported by Lit templates.  For full coverage, see [Templates](/docs/templates/overview/) in the Lit documentation.

...
|-----------|---------|--------------|
| {% api-lit-v2 "@customElement" "customElement" %} | Defines a custom element | [Above](#custom-element) |
| {% api-lit-v2 "@eventOptions" "eventOptions" %} | Adds event listener options. | [Events](/docs/v2/components/events/#event-options-decorator) |
| {% api-lit-v2 "@property" "property" %} | Defines a public property. | [Properties](/docs/v2/components/properties/#declare-with-decorators) |
| {% api-lit-v2 "@state" "state" %} | Defines a private state property | [Properties](/docs/v2/components/properties/#declare-with-decorators) |
| {% api-lit-v2 "@query" "query" %} | Defines a property that returns an element in the component template. | [Shadow DOM](/docs/v2/components/shadow-dom/#query) |
| {% api-lit-v2 "@queryAll" "queryAll" %} | Defines a property that returns a list of elements in the component template. | [Shadow DOM](/docs/v2/components/shadow-dom/#query-all) |
| {% api-lit-v2 "@queryAsync" "queryAsync" %} | Defines a property that returns a promise that resolves to an element in the component template. | [Shadow DOM](/docs/v2/components/shadow-dom/#query-async) |
| {% api-lit-v2 "@queryAssignedElements" "queryAssignedElements" %} | Defines a property that returns the child elements assigned to a specific slot. | [Shadow DOM](/docs/v2/components/shadow-dom/#query-assigned-nodes) |
| {% api-lit-v2 "@queryAssignedNodes" "queryAssignedNodes" %} | Defines a property that returns the child nodes assigned to a specific slot. | [Shadow DOM](/docs/v2/components/shadow-dom/#query-assigned-nodes) |

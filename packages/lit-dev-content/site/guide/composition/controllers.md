...
The reactive controller lifecycle is a subset of the [reactive update cycle](/guide/components/lifecycle#reactive-update-cycle). LitElement calls into any installed controllers during its lifecycle callbacks. These callbacks are optional.

...
- Update content from existing LitElement docs, below. (Currently unchanged except for replacing LitElement with Lit)
- Edit for consistency.

{% endtodo %}

This page describes how to publish a Lit component to npm.
